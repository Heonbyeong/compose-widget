...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxComposeLibraryAccessors extends SubDependencyFactory {
        private final AndroidxComposeGlanceLibraryAccessors laccForAndroidxComposeGlanceLibraryAccessors = new AndroidxComposeGlanceLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.compose.glance</b>
         */
        public AndroidxComposeGlanceLibraryAccessors getGlance() {
            return laccForAndroidxComposeGlanceLibraryAccessors;
        }

    }

    public static class AndroidxComposeGlanceLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public AndroidxComposeGlanceLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>glance</b> with <b>androidx.glance:glance-appwidget</b> coordinates and
         * with version reference <b>glance</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("androidx.compose.glance");
        }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getMaterial3() {
            return create("androidx.compose.glance.material3");
        }
